...
class DragAndDropImageDialog extends PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return <>
      <div className={classes.controls}>
        ...
        <Tooltip title="Очистить изображение">
      ...
      <Tooltip title="Перетащите нужный файл в данную область или щелкните по ней чтобы открыть диалог выбора файла">
        ...
        >
          <div className={classes.imgContainer}>{
            this.src ? <ValueImg src={this.src} onMouseOver={onMouseOver} />
            : <DropImageIcon onMouseOver={onMouseOver} />
          }</div>
        </div>
      </Tooltip>
    </>;
...
DragAndDropImageDialog = withStyles(styles)(DragAndDropImageDialog);
...
export default React.memo(DragAndDropImageDialogInput);